          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-foreground mb-4 text-balance">
                Pronto para Brilhar no{' '}
                <span className="text-primary">Palco</span>?
              </h2>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/sobre">
                  <Button variant="outline" size="lg" className="border-border hover:bg-secondary h-12 px-6">
                    Saiba Mais
                  </Button>
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 lg:gap-6">
              <div className="bg-secondary/50 rounded-2xl p-6">
                ...
                <p className="text-sm text-muted-foreground">Gratuito para cadastro</p>
              </div>
              <div className="bg-secondary/50 rounded-2xl p-6">
                <p className="text-3xl lg:text-4xl font-bold text-primary mb-1">24h</p>
                <p className="text-sm text-muted-foreground">Aprovação rápida</p>
              </div>
              <div className="bg-secondary/50 rounded-2xl p-6">
                <p className="text-3xl lg:text-4xl font-bold text-primary mb-1">50k+</p>
                <p className="text-sm text-muted-foreground">Usuários ativos</p>
              </div>
              <div className="bg-secondary/50 rounded-2xl p-6">
                <p className="text-3xl lg:text-4xl font-bold text-primary mb-1">R$5M+</p>
                <p className="text-sm text-muted-foreground">Movimentados</p>
              </div>
            </div>
          </div>
        </div>
